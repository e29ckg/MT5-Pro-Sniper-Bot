...
# 🌟 เพิ่ม Dropdown ให้เลือกสไตล์การป้องกันทุน
...
with tab1:
    ...
    def render_live_dashboard():
        ...
        if fresh_config.get("bot_status") == "running":
            st.success(f"🟢 **สถานะ:** {fresh_config.get('current_activity', 'เตรียมความพร้อม...')}")
        else:
        ...
        b3.markdown(f"**โหมดการทำงาน:** <br>📡 {mode}", unsafe_allow_html=True)
